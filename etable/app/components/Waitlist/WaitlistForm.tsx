...
export default function WaitListFor() {
        ...
        <main className="min-h-screen bg-black text-[#d4af37] py-16 px-6">
            <div className="max-w-3xl mx-auto">
                <header className="mb-8 text-center">
                    ...
                    /></Link>
                    <h1 className="mt-4 text-lg! md:text-4xl! text-[#d4af37]">
                ...
                >
                    ...
                    <div className="mt-4 flex items-center gap-3">
                        <button
                            ...
                            className="cursor-pointer flex-1 rounded-md px-4 py-2 font-medium text-black bg-linear-to-r from-[#d4af37] to-[#D4AF37] hover:opacity-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
